...
##### Usando somente listas, sem dicionários!
# Modelo de Gbat
...
print(sorted(zip(l_palavras,l_ocorrencias),key= lambda x :x[1],reverse=True)[0:5])
