...
while True:
    ...
    #print("Tab Ini",tabela_cpf_mac) # testes
    ...
    if opcao == 1: # a
        ...
        if cpf.cpf_valido(var_1) and var_1 not in tabela_cpf_mac.keys():
            ...
            tabela_cpf_mac[var_1] = []
            print(f'O CPF {var_1} foi cadastrado!')                     ############ NW
        else:
        ...
        if len(tabela_cpf_mac) == 0:
            ...
            if cpf.cpf_valido(var_3) and (var_3) in tabela_cpf_mac.keys():
                ...
                if check_mac(var_4):
                    ...
                    #print(lista_temp,type(lista_temp),'1') ############# # testes


                    #lista_temp = lista_temp.append(var_4)

                    lista_temp += [var_4]
                    #print (lista_temp,'1.5')

                    #print(tabela_cpf_mac[var_3],"2") ############## # testes
                    tabela_cpf_mac[var_3] = lista_temp #???????????????????????
                    #print("temp",tabela_cpf_mac[var_3],3) # testes
                else:
            ...
            if (var_5) in tabela_cpf_mac.keys():
                ...
                if check_mac(var_6) == True:
                    ...
                    if var_6 in lista_temp2:
                        ...
                        lista_temp2 = lista_temp2.remove(var_6)
                        if lista_temp2 == None:
                            lista_temp2 = []
                        ...
                        #print("temp",tabela_cpf_mac[var_5],'3.1') # testes
                    else:
        ...
        if cpf.cpf_valido(var_7) == True:
            if (var_7) in tabela_cpf_mac.keys():
                ...
                if len(lista_temp3) == 0:
                    ...
                    print (f"O CPF {var_7} foi REMOVIDO!")                  ############ NW
                else:
    ...
    if opcao == 5: # e
        ...
        for var in tabela_cpf_mac.keys():
            print("CPF:",var)
        if len(tabela_cpf_mac.keys()) == 0: print("Não há CPFs cadastrados!")   ############ NW
    ###################################################################################################################
    ###################################################################################################################
    ...
    if opcao == 7: # g
            ...
            ##### VERIFICA SE O ARQUIVO EXISTE #####
                ...
                for a in tabela_cpf_mac.keys():                     ################ NW
